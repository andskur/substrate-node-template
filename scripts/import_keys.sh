...
curl  http://localhost:9934 -H "Content-Type:application/json;charset=utf-8" --data "$(generateRpcRequest aura $KEY_SR25519)"

# Submit a new grandpa ed25519 key via RPC
curl  http://localhost:9934 -H "Content-Type:application/json;charset=utf-8" --data "$(generateRpcRequest gran $KEY_ED25519)"
